...
F_0_3 = flux/Ls*arm_cos_f32(xD[3]);
//F_1_0 = 0.0f;
F_1_1 = -Rs/Ls;
F_1_2 = -flux/Ls*arm_cos_f32(xD[3]);
F_1_3 = flux/Ls*arm_sin_f32(xD[3]);
//F_2_0 = 0.0f;
//F_2_1 = 0.0f;
//F_2_2 = 0.0f;
//F_2_3 = 0.0f;
...
// ==================== 第一阶段：计算 temp_P = Φ * P_old ====================
// 使用临时变量避免覆盖
float temp_P_0_0 = f2_0_0 * P0_0_0 + f2_0_2 * P0_2_0 + f2_0_3 * P0_3_0;
float temp_P_0_1 = f2_0_0 * P0_0_1 + f2_0_2 * P0_2_1 + f2_0_3 * P0_3_1;
float temp_P_0_2 = f2_0_0 * P0_0_2 + f2_0_2 * P0_2_2 + f2_0_3 * P0_3_2;
float temp_P_0_3 = f2_0_0 * P0_0_3 + f2_0_2 * P0_2_3 + f2_0_3 * P0_3_3;

float temp_P_1_0 = f2_1_1 * P0_1_0 + f2_1_2 * P0_2_0 + f2_1_3 * P0_3_0;
float temp_P_1_1 = f2_1_1 * P0_1_1 + f2_1_2 * P0_2_1 + f2_1_3 * P0_3_1;
float temp_P_1_2 = f2_1_1 * P0_1_2 + f2_1_2 * P0_2_2 + f2_1_3 * P0_3_2;
float temp_P_1_3 = f2_1_1 * P0_1_3 + f2_1_2 * P0_2_3 + f2_1_3 * P0_3_3;

float temp_P_2_0 = f2_2_2 * P0_2_0;
float temp_P_2_1 = f2_2_2 * P0_2_1;
float temp_P_2_2 = f2_2_2 * P0_2_2;
float temp_P_2_3 = f2_2_2 * P0_2_3;

float temp_P_3_0 = f2_3_2 * P0_2_0 + f2_3_3 * P0_3_0;
float temp_P_3_1 = f2_3_2 * P0_2_1 + f2_3_3 * P0_3_1;
float temp_P_3_2 = f2_3_2 * P0_2_2 + f2_3_3 * P0_3_2;
float temp_P_3_3 = f2_3_2 * P0_2_3 + f2_3_3 * P0_3_3;

// ==================== 第二阶段：计算 P_pred = temp_P * Φᵀ + Q ====================
P_pred_0_0 = temp_P_0_0 * f2_0_0 + temp_P_0_2 * f2_0_2 + temp_P_0_3 * f2_0_3 + Q_0_0;
P_pred_0_1 = temp_P_0_1 * f2_1_1 + temp_P_0_2 * f2_1_2 + temp_P_0_3 * f2_1_3;
P_pred_0_2 = temp_P_0_2 * f2_2_2;
P_pred_0_3 = temp_P_0_2 * f2_3_2 + temp_P_0_3 * f2_3_3;

P_pred_1_0 = temp_P_1_0 * f2_0_0 + temp_P_1_2 * f2_0_2 + temp_P_1_3 * f2_0_3;
P_pred_1_1 = temp_P_1_1 * f2_1_1 + temp_P_1_2 * f2_1_2 + temp_P_1_3 * f2_1_3 + Q_1_1;
P_pred_1_2 = temp_P_1_2 * f2_2_2;
P_pred_1_3 = temp_P_1_2 * f2_3_2 + temp_P_1_3 * f2_3_3;

P_pred_2_0 = temp_P_2_0 * f2_0_0 + temp_P_2_2 * f2_0_2 + temp_P_2_3 * f2_0_3;
P_pred_2_1 = temp_P_2_1 * f2_1_1 + temp_P_2_2 * f2_1_2 + temp_P_2_3 * f2_1_3;
P_pred_2_2 = temp_P_2_2 * f2_2_2 + Q_2_2;
P_pred_2_3 = temp_P_2_2 * f2_3_2 + temp_P_2_3 * f2_3_3;

P_pred_3_0 = temp_P_3_0 * f2_0_0 + temp_P_3_2 * f2_0_2 + temp_P_3_3 * f2_0_3;
P_pred_3_1 = temp_P_3_1 * f2_1_1 + temp_P_3_2 * f2_1_2 + temp_P_3_3 * f2_1_3;
P_pred_3_2 = temp_P_3_2 * f2_2_2;
P_pred_3_3 = temp_P_3_2 * f2_3_2 + temp_P_3_3 * f2_3_3 + Q_3_3;
...
// 先完整计算所有 P_pred * H （不修改原 K）
float KH_0_0 = P_pred_0_0 * H_0_0;   // K列0 对 y0 的贡献
float KH_0_1 = P_pred_0_1 * H_1_1;   // K列0 对 y1
float KH_1_0 = P_pred_1_0 * H_0_0;
float KH_1_1 = P_pred_1_1 * H_1_1;
float KH_2_0 = P_pred_2_0 * H_0_0;
float KH_2_1 = P_pred_2_1 * H_1_1;
float KH_3_0 = P_pred_3_0 * H_0_0;
float KH_3_1 = P_pred_3_1 * H_1_1;

// 现在用 S^{-1} 乘以这些原始 KH，得到真正的 K
K_0_0 = KH_0_0 * temp_0_0 + KH_0_1 * temp_1_0;
K_0_1 = KH_0_0 * temp_0_1 + KH_0_1 * temp_1_1;

K_1_0 = KH_1_0 * temp_0_0 + KH_1_1 * temp_1_0;
K_1_1 = KH_1_0 * temp_0_1 + KH_1_1 * temp_1_1;

K_2_0 = KH_2_0 * temp_0_0 + KH_2_1 * temp_1_0;
K_2_1 = KH_2_0 * temp_0_1 + KH_2_1 * temp_1_1;

K_3_0 = KH_3_0 * temp_0_0 + KH_3_1 * temp_1_0;
K_3_1 = KH_3_0 * temp_0_1 + KH_3_1 * temp_1_1;
